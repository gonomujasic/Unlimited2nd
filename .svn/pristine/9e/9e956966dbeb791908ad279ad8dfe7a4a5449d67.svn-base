	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="box box-success">
				...
				<div class="box-body">
					<label for="qna_reply_id">Writer</label> <input
						class="form-control" type="text" placeholder="USER ID"
						id="newReplyWriter"> <label for="qna_reply_contents">Reply
...
{{#each .}}
<li class="replyLi" data-rno={{qna_reply_number}}>
...
<script>
	...
	$(".pagination").on("click", "li a", function(event){
		...
		getPage("../replies/"+qna_number+"/"+replyPage);

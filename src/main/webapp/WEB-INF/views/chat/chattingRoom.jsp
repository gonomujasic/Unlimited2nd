...
>>>>>>> .r125
		<table class="table">
			...
			<span style="margin-left: 3px;"><input type="text" id="roomNumber"
				value="${chatRoomDTO.chatRoomNum}" readonly="readonly"></span>
			<span style="margin-left: 5px;"><input type="text" id="title"
	...
	<script type="text/javascript">
		...
		function connect() {
			var socket = new SockJS(
					'http://localhost:8080/Unlimited2nd/chatEndpoint/');
		...
		function showResult(message) {
			...
			var str = message.from + "("+message.time+"): " + message.message;

	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="box box-success">
				...
				<div class="box-body">
					<label for="notice_reply_id">Writer</label> <input
						class="form-control" type="text" placeholder="USER ID"
						id="newReplyWriter"> <label for="notice_reply_contents">Reply
...
{{#each .}}
<li class="replyLi" data-rno={{notice_reply_number}}>
...
<script>
	...
	$("#repliesDiv").on("click", function() {
		...
		getPage("../replies/" + notice_number + "/1");
	...
	$(".pagination").on("click", "li a", function(event){
		...
		getPage("../replies/"+notice_number+"/"+replyPage);
...
// 		 alert(replyer);
	...
	$("#replyModBtn").on("click",function(){
		  ...
		  $.ajax({
				type:'put',
				url:'../replies/'+notice_reply_number,
				headers: { 
				      "Content-Type": "application/json",
